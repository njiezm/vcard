...
@section('title', __('Page Introuvable - vCard Elite'))
...
@section('message')
    ...
    <style>
        ...
        /* On utilise un wrapper fixe pour garantir le centrage absolu sur l'écran */
        .full-center-wrapper {
            position: fixed;
            top: 0;
            left: 0;
    ...
    <div class="full-center-wrapper">
        ...
        <div class="error-container">
            <span class="terminal-text">Error_Code: 404 // Signal_Lost</span>
            
            <div class="glitch-code float-anim">
                404
            </div>
            
            <h2 class="text-3xl font-bold mb-4 text-white">Espace Introuvable</h2>
            
            <p class="error-message">
                La destination que vous tentez de rejoindre n'existe pas ou a été déplacée vers une zone sécurisée.
            </p>
            
            <a href="{{ url('/') }}" class="btn-elite">
                <i class="fas fa-home text-xs"></i> Retour au Hub
            </a>
            ...
            <div class="mt-16 opacity-20">
                <div class="flex justify-center items-center gap-3 text-white">
                    ...
                    <span class="font-mono text-[10px] tracking-widest uppercase">Obsidian_System_Core</span>
                </div>
            </div>
        </div>
    </div>
