...
@section('title', __('Erreur Serveur - vCard Elite'))
...
@section('message')
    ...
    <div class="full-center-wrapper">
        ...
        <div class="error-container">
            <span class="terminal-text">Error_Code: 500 // System_Critical_Failure</span>
            
            <div class="glitch-code float-anim">
                500
            </div>
            
            <h2 class="text-3xl font-bold mb-4 text-white">Erreur Interne</h2>
            
            <p class="error-message">
                Une défaillance critique est survenue sur le serveur principal. Nos techniciens ont été notifiés et travaillent sur le rétablissement du flux.
            </p>
            
            <a href="{{ url('/') }}" class="btn-elite">
                <i class="fas fa-redo text-xs"></i> Revenir au Hub
            </a>
            ...
            <div class="mt-16 opacity-20">
                <div class="flex justify-center items-center gap-3 text-white">
                    ...
                    <span class="font-mono text-[10px] tracking-widest uppercase">Obsidian_Core_Stability_Alert</span>
                </div>
            </div>
        </div>
    </div>
